    ...
    <div className="w-full min-h-screen ">
      <div className={`flex flex-col`}>
        <div className={`relative w-full max-w-lg`}>
          ...
          <div
            className={`absolute top-0 -right-350 w-150 h-150 bg-yellow-400 rounded-full -mix-blend-multiply filter  blur-3xl  opacity-30`}/>
          <div
            className={`absolute top-0 -right-400 w-150 h-150 bg-orange-500 rounded-full -mix-blend-multiply filter blur-3xl opacity-50`}/>
        </div>
        ...
        <div className={`w-full flex items-center justify-center`}>
          <h1 className={`text-(--body-font-color) text-6xl font-serif italic`}>Some <span className={`text-(--body-font-highlight)`}>random ass</span> title.</h1>
        </div>
        <div className={`grid grid-cols-2 grid-rows-2 h-96 outline-2 outline-blue-500 place-items-center`}>
          <div className={`flex place-items-center flex-col`}>
            <h2 className={`text-(--body-font-color) font-bold`}>image</h2>
            <h2 className={`text-(--body-font-color) font-bold`}>Woah, another title</h2>
            <p className={`text-(--body-font-color)`}>Is that a video on the right? Oh, cool. Paste a pre-recorded video
        ...
        <div className={`grid grid-cols-3 w-full text-black place-items-center h-96`}>
          <div>iamge</div>
          <div>
            <h1 className={` font-serif text-(--body-font-color) text-6xl text-center`}>We believe in <br/> <span className={` font-serif underline text-(--body-font-highlight)`}>something.</span> </h1>
          </div>
          <div>image</div>
        </div>
      </div>
